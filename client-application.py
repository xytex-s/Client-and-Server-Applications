...
# TODO: Implement RSA encryption for AES keys
import socket
import sys
import hashlib
import os, time
...
#Generate certificate SHA-256 hash of file content
...
SERVER_IP = '127.0.0.1'  # Change for assessment
...
def manual_send_logs():
    ...
    for log_file in log_files:
        try:
            ...
            print(f"Failed to send {log_file}: {e}")
